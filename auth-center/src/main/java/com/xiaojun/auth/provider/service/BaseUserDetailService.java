package com.xiaojun.auth.provider.service;
...
import com.xiaojun.user.client.BaseModuleResourceService;
import com.xiaojun.user.client.BaseRoleService;
import com.xiaojun.user.client.BaseUserService;
